...
const CustomersDashboard = () => {
  const dashboardData = [
    ...
    { id: '2', label: 'Total Customer', value: '352', additionalInfo: 'Archived (3)', icon: <Paushed/> },  // Emoji for store
...
const styles = StyleSheet.create({
  ...
  iconContainer: {
    borderRadius: wp(12.5), // Responsive border radius for the icon container
  },
  icon: {
  ...
  additionalInfo: {
    ...
    color: '#373737',
    marginTop: hp(0.15), // Responsive margin top
